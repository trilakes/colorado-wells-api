...
OVERLAY_LAYERS = {
    'contamination': {
        ...
        'bbox_cols': 'site_id, site_name, latitude, longitude, state, county, category, npl_status, superfund',
    },
    'superfund': {
        'table': 'superfund_sites',
        'label': 'Superfund Sites',
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'epa_id, site_name, latitude, longitude, state, county, npl_status',
    },
    'oilgas': {
        'table': 'oil_gas_wells',
        'label': 'Oil & Gas Wells',
    ...
    'tri': {
        ...
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'facility_id, facility_name, latitude, longitude, state, county, city, address, parent_company, closed, chemicals, latest_report_year, total_reports, total_air_lbs, total_water_lbs, total_land_lbs, total_release_lbs, active_years',
    },
    'radon': {
        'table': 'radon_zones',
        'label': 'Radon Zones',
    ...
    'wqstations': {
        ...
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'station_id, name, latitude, longitude, state, county, organization, site_type, result_count',
    },
    'brownfields': {
        'table': 'brownfield_sites',
        'label': 'Brownfield Sites',
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'registry_id, site_name, latitude, longitude, state, county, city, epa_id, property_id, cleanup_ind, assess_ind',
    },
    'rcra': {
        'table': 'rcra_sites',
        'label': 'RCRA Corrective Action',
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'handler_id, handler_name, latitude, longitude, state, county, city, epa_id, gpra_ca',
    },
    'fedfac': {
        'table': 'federal_facilities',
        'label': 'Federal Facilities',
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'registry_id, site_name, latitude, longitude, state, county, city, epa_id, agency_owner, federal_agency, ff_superfund, ff_rcra, ff_brac',
    },
    'eparesponse': {
        'table': 'epa_response_sites',
        'label': 'EPA Emergency Response',
        'lat': 'latitude', 'lng': 'longitude',
        'bbox_cols': 'registry_id, site_name, latitude, longitude, state, county, city, epa_id, osc_site_id, response_type, response_status',
    },
    'mines': {
        'table': 'mine_sites',
        'label': 'Mine Sites',
